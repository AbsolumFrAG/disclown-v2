...
export function useCreateServerMutation() {
  return Urql.useMutation<CreateServerMutation, CreateServerMutationVariables>(
...
export function useFriendsQuery(
  ...
  return Urql.useQuery<FriendsQuery, FriendsQueryVariables>({
...
export function useServersQuery(
  options?: Omit<Urql.UseQueryArgs<ServersQueryVariables>, "query">
) {
  return Urql.useQuery<ServersQuery, ServersQueryVariables>({
